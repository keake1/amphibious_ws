...
#include "base_lidar/srv/detail/control__rosidl_typesupport_fastrtps_c.h"
...
#include "base_lidar/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
...
using _Control_Request__ros_msg_type = base_lidar__srv__Control_Request;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_lidar
size_t get_serialized_size_base_lidar__srv__Control_Request(
  const void * untyped_ros_message,
...
static uint32_t _Control_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_base_lidar__srv__Control_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_lidar
size_t max_serialized_size_base_lidar__srv__Control_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_lidar__srv__Control_Request;
    is_plain =
      (
...
static size_t _Control_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_lidar__srv__Control_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_lidar, srv, Control_Request)() {
...
using _Control_Response__ros_msg_type = base_lidar__srv__Control_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_lidar
size_t get_serialized_size_base_lidar__srv__Control_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _Control_Response__ros_msg_type * ros_message = static_cast<const _Control_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_base_lidar__srv__Control_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_base_lidar
size_t max_serialized_size_base_lidar__srv__Control_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_lidar__srv__Control_Response;
    is_plain =
      (
...
static size_t _Control_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_base_lidar__srv__Control_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_lidar, srv, Control_Response)() {
...
// already included above
// #include "base_lidar/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "base_lidar/srv/control.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, base_lidar, srv, Control)() {
