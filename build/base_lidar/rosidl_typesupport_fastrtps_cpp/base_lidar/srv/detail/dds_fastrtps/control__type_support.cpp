...
#include "base_lidar/srv/detail/control__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = base_lidar::srv::Control_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_lidar::srv::Control_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<base_lidar::srv::Control_Request *>(
    untyped_ros_message);
...
template<>
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_EXPORT_base_lidar
const rosidl_message_type_support_t *
get_message_type_support_handle<base_lidar::srv::Control_Request>()
{
  return &base_lidar::srv::typesupport_fastrtps_cpp::_Control_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = base_lidar::srv::Control_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const base_lidar::srv::Control_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<base_lidar::srv::Control_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &base_lidar::srv::typesupport_fastrtps_cpp::_Control_Response__handle;
}
...
{
  return &base_lidar::srv::typesupport_fastrtps_cpp::_Control__handle;
}
