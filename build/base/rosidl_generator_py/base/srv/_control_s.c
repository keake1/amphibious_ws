...
bool base__srv__control__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base.srv._control.Control_Request", full_classname_dest, 33) == 0);
  }
  base__srv__Control_Request * ros_message = _ros_message;
  {  // topic
...
PyObject * base__srv__control__request__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("base.srv._control");
...
ROSIDL_GENERATOR_C_EXPORT
bool base__srv__control__response__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("base.srv._control.Control_Response", full_classname_dest, 34) == 0);
  }
  base__srv__Control_Response * ros_message = _ros_message;
  {  // code
