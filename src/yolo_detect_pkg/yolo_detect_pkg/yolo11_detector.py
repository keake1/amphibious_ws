...
class Yolo11DetectorNode(Node):
    def __init__(self):
        super().__init__('yolo11_detector_node')
        self.bridge = CvBridge()
        self.model = YOLO11_Detect(self.get_opt())
    ...
    def image_callback(self, msg):
        try:
            ...
            self.get_logger().error(f'cv_bridge转换失败: {e}')
            return
        ...
        self.detected_image_pub_.publish(detected_msg)
