...
base_lidar__srv__Control_Request__init(base_lidar__srv__Control_Request * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->topic)) {
    base_lidar__srv__Control_Request__fini(msg);
    return false;
  }
  // func
...
base_lidar__srv__Control_Request__create()
{
  ...
  base_lidar__srv__Control_Request * msg = (base_lidar__srv__Control_Request *)allocator.allocate(sizeof(base_lidar__srv__Control_Request), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(base_lidar__srv__Control_Request));
  bool success = base_lidar__srv__Control_Request__init(msg);
  if (!success) {
...
base_lidar__srv__Control_Request__Sequence__init(base_lidar__srv__Control_Request__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_lidar__srv__Control_Request * data = NULL;

  if (size) {
    data = (base_lidar__srv__Control_Request *)allocator.zero_allocate(size, sizeof(base_lidar__srv__Control_Request), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = base_lidar__srv__Control_Request__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        base_lidar__srv__Control_Request__fini(&data[i - 1]);
      }
...
base_lidar__srv__Control_Request__Sequence__fini(base_lidar__srv__Control_Request__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      base_lidar__srv__Control_Request__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_lidar__srv__Control_Request__Sequence * array = (base_lidar__srv__Control_Request__Sequence *)allocator.allocate(sizeof(base_lidar__srv__Control_Request__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = base_lidar__srv__Control_Request__Sequence__init(array, size);
  if (!success) {
...
base_lidar__srv__Control_Request__Sequence__destroy(base_lidar__srv__Control_Request__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    base_lidar__srv__Control_Request__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
base_lidar__srv__Control_Request__Sequence__are_equal(const base_lidar__srv__Control_Request__Sequence * lhs, const base_lidar__srv__Control_Request__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!base_lidar__srv__Control_Request__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  base_lidar__srv__Control_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(base_lidar__srv__Control_Request);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    base_lidar__srv__Control_Request * data =
      (base_lidar__srv__Control_Request *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!base_lidar__srv__Control_Request__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          base_lidar__srv__Control_Request__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!base_lidar__srv__Control_Request__copy(
...
base_lidar__srv__Control_Response__init(base_lidar__srv__Control_Response * msg)
{
  ...
  if (!rosidl_runtime_c__String__init(&msg->value)) {
    base_lidar__srv__Control_Response__fini(msg);
    return false;
  }
  return true;
}
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_lidar__srv__Control_Response * msg = (base_lidar__srv__Control_Response *)allocator.allocate(sizeof(base_lidar__srv__Control_Response), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(base_lidar__srv__Control_Response));
  bool success = base_lidar__srv__Control_Response__init(msg);
  if (!success) {
    allocator.deallocate(msg, allocator.state);
    return NULL;
  }
...
base_lidar__srv__Control_Response__Sequence__init(base_lidar__srv__Control_Response__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_lidar__srv__Control_Response * data = NULL;

  if (size) {
    data = (base_lidar__srv__Control_Response *)allocator.zero_allocate(size, sizeof(base_lidar__srv__Control_Response), allocator.state);
    if (!data) {
      return false;
    }
    // initialize all array elements
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = base_lidar__srv__Control_Response__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      // if initialization failed finalize the already initialized array elements
      for (; i > 0; --i) {
        base_lidar__srv__Control_Response__fini(&data[i - 1]);
      }
      allocator.deallocate(data, allocator.state);
      return false;
    }
...
base_lidar__srv__Control_Response__Sequence__fini(base_lidar__srv__Control_Response__Sequence * array)
{
  ...
  if (array->data) {
    ...
    // finalize all array elements
    for (size_t i = 0; i < array->capacity; ++i) {
      base_lidar__srv__Control_Response__fini(&array->data[i]);
    }
    allocator.deallocate(array->data, allocator.state);
    array->data = NULL;
    array->size = 0;
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  base_lidar__srv__Control_Response__Sequence * array = (base_lidar__srv__Control_Response__Sequence *)allocator.allocate(sizeof(base_lidar__srv__Control_Response__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = base_lidar__srv__Control_Response__Sequence__init(array, size);
  if (!success) {
    allocator.deallocate(array, allocator.state);
    return NULL;
  }
...
base_lidar__srv__Control_Response__Sequence__destroy(base_lidar__srv__Control_Response__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    base_lidar__srv__Control_Response__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
base_lidar__srv__Control_Response__Sequence__are_equal(const base_lidar__srv__Control_Response__Sequence * lhs, const base_lidar__srv__Control_Response__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!base_lidar__srv__Control_Response__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  base_lidar__srv__Control_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(base_lidar__srv__Control_Response);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    base_lidar__srv__Control_Response * data =
      (base_lidar__srv__Control_Response *)allocator.reallocate(
      output->data, allocation_size, allocator.state);
    if (!data) {
      return false;
    }
    ...
    output->data = data;
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!base_lidar__srv__Control_Response__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          base_lidar__srv__Control_Response__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  output->size = input->size;
  for (size_t i = 0; i < input->size; ++i) {
    if (!base_lidar__srv__Control_Response__copy(
        &(input->data[i]), &(output->data[i])))
    {
      return false;
    }
