...
class Metaclass_Control_Request(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            module = import_type_support('base_lidar')
        except ImportError:
            import logging
            import traceback
...
class Metaclass_Control(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            from base_lidar.srv import _control
...
class Control(metaclass=Metaclass_Control):
    from base_lidar.srv._control import Control_Request as Request
    from base_lidar.srv._control import Control_Response as Response
